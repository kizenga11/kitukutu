  ...
  <ul class="sidebar-nav" style="list-style:none;padding:0;">
    ...
    <li class="nav-group">
      ...
      <ul class="nav-sub">
        ...
        <li><a href="../admin/messages.php" target="mainFrame"><i class="bi bi-envelope"></i> Messages <?php if($unread_messages>0): ?><span style="background:#ef4444;color:#fff;border-radius:20px;font-size:10px;padding:1px 7px;margin-left:auto;font-weight:700"><?=$unread_messages?></span><?php endif;?></a></li>
      </ul>
    </li>
  </ul>
</aside>
...
function updateBreadcrumb(href){
  ...
  var groupText=group?group.textContent.trim():'Headmaster';
