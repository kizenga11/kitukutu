...
<div class="topbar">
  ...
  <div class="topbar-info" style="flex:1;min-width:0;">
    ...
    <div class="sub"><?= $subject_name ? htmlspecialchars($subject_name).' &mdash; '.htmlspecialchars($exam_name) : 'Select a subject and exam to analyse' ?></div>
  </div>
  <?php if (!empty($data)): ?>
...
<div class="content">
    ...
    <form method="GET">
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;">
        <div>
          ...
          <select name="subject_id" class="f-select" required>
  ...
  <div style="display:none" class="print-only">
    <h4 style="margin:0 0 4px"><?= htmlspecialchars($subject_name) ?> — <?= htmlspecialchars($exam_name) ?></h4>
    <p style="font-size:12px;color:#555;margin:0 0 10px">Kitukutu Secondary Technical School &bull; <?= date('d M Y') ?></p>
  </div>

  <!-- Student list -->
  <div class="sec-hdr"><i class="bi bi-people-fill"></i> Student Results <span><?= htmlspecialchars($exam_name) ?></span></div>
  ...
  <div class="stu-row">
    ...
    <div class="stu-name">
      ...
      <div class="sex-dot"><?= $d['sex'] === 'F' ? 'Female' : 'Male' ?></div>
    </div>
